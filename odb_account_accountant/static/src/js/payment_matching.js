odoo.define('odb_account_accountant.ReconciliationClientAction', function (require) {
    "use strict";

    var AbstractAction = require('web.AbstractAction');
    var ReconciliationModel = require('odb_account_accountant.ReconciliationModel');
    var ReconciliationRenderer = require('odb_account_accountant.ReconciliationRenderer');

...
class ReportTrialBalance(models.AbstractModel):
    _name = 'report.odb_account_reports_pdf.report_trialbalance'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if data['form'].get('analytic_account_ids'):
            ...
            analytic_accounts = [
                account.name for account in analytic_account_ids]
        account_res = self.with_context(
            context)._get_accounts(accounts, display_account)
        codes = []

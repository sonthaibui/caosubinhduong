...
class TemplateSettings(models.Model):
    ...
    is_custom_header_footer = fields.Boolean(string='Custom Header Footer', default=False)
    show_image = fields.Boolean(string='Show Image', default=True)

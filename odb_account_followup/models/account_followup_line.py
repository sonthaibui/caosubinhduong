...
class FollowupLine(models.Model):
    ...
    def _compute_sequence(self):
        delays = [line.delay for line in self.followup_id.followup_line_ids]
        delays.sort()
        for line in self.followup_id.followup_line_ids:
    ...
    def default_get(self, default_fields):
        ...
        if self.env.ref('odb_account_followup.email_template_odb_account_followup_default'):
            values['email_template_id'] = self.env.ref('odb_account_followup.email_template_odb_account_followup_default').id
        return values
